			...
			<div className="display jumbotron">
				...
				<div className="form-group">	
					<div className="input-group input-group-md">
						<label for="dbName" className="post-put-delete">POST</label><br></br>
				...
				<div className="form-group">	
					<div className="input-group input-group-md">
						<label for="dbName" className="post-put-delete">PUT</label><br></br>
				...
				<form>
					<div className="form-group">	
						<div className="input-group input-group-md">
						<label for="dbName" className="post-put-delete">DELETE</label><br></br>
